...
// // Function to insert any CSV into a table
// function insertCSV(filePath, tableName, columns) {
//   const rows = [];
...
//         // Convert empty strings to null (especially for DATETIME fields)
...
//         if (tableName === 'orders') db.end(); // close after second table
//       });
//     });
// }

// // Insert users
// insertCSV('uploads/users.csv', 'users', [
...
// // Insert orders
// insertCSV('uploads/orders.csv', 'orders', [
